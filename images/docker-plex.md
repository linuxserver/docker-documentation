...
_Special note_ - If you'd like to run Plex without requiring `--net=host` \(`NOT recommended`\) then you will need the following ports in your `docker create` command \(you need to set PLEX\_CLAIM to claim a server set up with bridge networking\):
...
[![Docker Mods](https://img.shields.io/badge/dynamic/yaml?style=for-the-badge&color=E68523&label=mods&query=%24.mods%5B%27plex%27%5D.mod_count&url=https%3A%2F%2Fraw.githubusercontent.com%2Flinuxserver%2Fdocker-mods%2Fmaster%2Fmod-list.yml)](https://mods.linuxserver.io/?mod=plex)
