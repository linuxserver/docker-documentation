...
tags:
    - Media Management
description: "[VLC Media Player](https://www.videolan.org/vlc/) is a free and open source cross-platform multimedia player and framework that delivers dependable performance across multiple devices."
---
...
| Parameter | Function |
| :----: | --- |
| `3000:3000` | VLC Media Player desktop gui HTTP must be proxied. |
| `3001:3001` | VLC Media Player desktop gui HTTPS. |
...
| `VLC_CLI=--no-qt-minimal-view` | Specify one or multiple VLC CLI flags, this string will be passed to the application in full. |
