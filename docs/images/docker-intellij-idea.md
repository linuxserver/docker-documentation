...
tags:
    - Programming
description: "[IntelliJ IDEA](https://www.jetbrains.com/idea/) helps you write code faster with tools that eliminate tedious tasks and let you focus on what matters – building great software."
---
<!-- DO NOT EDIT THIS FILE MANUALLY -->
<!-- Please read https://github.com/linuxserver/docker-intellij-idea/blob/master/.github/CONTRIBUTING.md -->
# [linuxserver/intellij-idea](https://github.com/linuxserver/docker-intellij-idea)

[![Scarf.io pulls](https://scarf.sh/installs-badge/linuxserver-ci/linuxserver%2Fintellij-idea?color=94398d&label-color=555555&logo-color=ffffff&style=for-the-badge&package-type=docker)](https://scarf.sh)
[![GitHub Stars](https://img.shields.io/github/stars/linuxserver/docker-intellij-idea.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/linuxserver/docker-intellij-idea)
[![GitHub Release](https://img.shields.io/github/release/linuxserver/docker-intellij-idea.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/linuxserver/docker-intellij-idea/releases)
[![GitHub Package Repository](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=GitHub%20Package&logo=github)](https://github.com/linuxserver/docker-intellij-idea/packages)
[![GitLab Container Registry](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=GitLab%20Registry&logo=gitlab)](https://gitlab.com/linuxserver.io/docker-intellij-idea/container_registry)
[![Quay.io](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=Quay.io)](https://quay.io/repository/linuxserver.io/intellij-idea)
[![Docker Pulls](https://img.shields.io/docker/pulls/linuxserver/intellij-idea.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=pulls&logo=docker)](https://hub.docker.com/r/linuxserver/intellij-idea)
[![Docker Stars](https://img.shields.io/docker/stars/linuxserver/intellij-idea.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=stars&logo=docker)](https://hub.docker.com/r/linuxserver/intellij-idea)
[![Jenkins Build](https://img.shields.io/jenkins/build?labelColor=555555&logoColor=ffffff&style=for-the-badge&jobUrl=https%3A%2F%2Fci.linuxserver.io%2Fjob%2FDocker-Pipeline-Builders%2Fjob%2Fdocker-intellij-idea%2Fjob%2Fmaster%2F&logo=jenkins)](https://ci.linuxserver.io/job/Docker-Pipeline-Builders/job/docker-intellij-idea/job/master/)
[![LSIO CI](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=CI&query=CI&url=https%3A%2F%2Fci-tests.linuxserver.io%2Flinuxserver%2Fintellij-idea%2Flatest%2Fci-status.yml)](https://ci-tests.linuxserver.io/linuxserver/intellij-idea/latest/index.html)

[IntelliJ IDEA](https://www.jetbrains.com/idea/) helps you write code faster with tools that eliminate tedious tasks and let you focus on what matters – building great software.

[![intellij-idea](https://raw.githubusercontent.com/linuxserver/docker-templates/master/linuxserver.io/img/intellij-idea-logo.png)](https://www.jetbrains.com/idea/)

## Supported Architectures

We utilise the docker manifest for multi-platform awareness. More information is available from docker [here](https://distribution.github.io/distribution/spec/manifest-v2-2/#manifest-list) and our announcement [here](https://blog.linuxserver.io/2019/02/21/the-lsio-pipeline-project/).

Simply pulling `lscr.io/linuxserver/intellij-idea:latest` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
docker run --rm -it \
  --shm-size=1gb \
  -p 3001:3001 \
  lscr.io/linuxserver/intellij-idea:latest bash
```
...
| Parameter | Function |
| :----: | --- |
| `3000:3000` | IntelliJ IDEA desktop gui HTTP must be proxied. |
| `3001:3001` | IntelliJ IDEA desktop gui HTTPS. |
...
[![Docker Mods](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=intellij-idea&query=%24.mods%5B%27intellij-idea%27%5D.mod_count&url=https%3A%2F%2Fraw.githubusercontent.com%2Flinuxserver%2Fdocker-mods%2Fmaster%2Fmod-list.yml)](https://mods.linuxserver.io/?mod=intellij-idea "view available mods for this container.") [![Docker Universal Mods](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=universal&query=%24.mods%5B%27universal%27%5D.mod_count&url=https%3A%2F%2Fraw.githubusercontent.com%2Flinuxserver%2Fdocker-mods%2Fmaster%2Fmod-list.yml)](https://mods.linuxserver.io/?mod=universal "view available universal mods.")
...
* Shell access whilst the container is running:
    ...
    ```bash
    docker exec -it intellij-idea /bin/bash
    ```
...
* Container version number:
    ...
    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' intellij-idea
    ```

* Image version number:

    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/intellij-idea:latest
    ```
...
* Update images:
    ...
    * Single image:
        ...
        ```bash
        docker-compose pull intellij-idea
        ```
...
* Update containers:
    ...
    * Single container:
        ...
        ```bash
        docker-compose up -d intellij-idea
        ```
...
* Update the image:
    ...
    ```bash
    docker pull lscr.io/linuxserver/intellij-idea:latest
    ```
...
```bash
git clone https://github.com/linuxserver/docker-intellij-idea.git
cd docker-intellij-idea
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/intellij-idea:latest .
```
