...
tags:
    - Finance
description: "[Bitcoin Knots](https://bitcoinknots.org/) can be used as a desktop client for regular payments or as a full node server utility for merchants and other payment services."
---
<!-- DO NOT EDIT THIS FILE MANUALLY -->
<!-- Please read https://github.com/linuxserver/docker-bitcoin-knots/blob/master/.github/CONTRIBUTING.md -->
# [linuxserver/bitcoin-knots](https://github.com/linuxserver/docker-bitcoin-knots)

[![Scarf.io pulls](https://scarf.sh/installs-badge/linuxserver-ci/linuxserver%2Fbitcoin-knots?color=94398d&label-color=555555&logo-color=ffffff&style=for-the-badge&package-type=docker)](https://scarf.sh)
[![GitHub Stars](https://img.shields.io/github/stars/linuxserver/docker-bitcoin-knots.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/linuxserver/docker-bitcoin-knots)
[![GitHub Release](https://img.shields.io/github/release/linuxserver/docker-bitcoin-knots.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/linuxserver/docker-bitcoin-knots/releases)
[![GitHub Package Repository](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=GitHub%20Package&logo=github)](https://github.com/linuxserver/docker-bitcoin-knots/packages)
[![GitLab Container Registry](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=GitLab%20Registry&logo=gitlab)](https://gitlab.com/linuxserver.io/docker-bitcoin-knots/container_registry)
[![Quay.io](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=Quay.io)](https://quay.io/repository/linuxserver.io/bitcoin-knots)
[![Docker Pulls](https://img.shields.io/docker/pulls/linuxserver/bitcoin-knots.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=pulls&logo=docker)](https://hub.docker.com/r/linuxserver/bitcoin-knots)
[![Docker Stars](https://img.shields.io/docker/stars/linuxserver/bitcoin-knots.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=stars&logo=docker)](https://hub.docker.com/r/linuxserver/bitcoin-knots)
[![Jenkins Build](https://img.shields.io/jenkins/build?labelColor=555555&logoColor=ffffff&style=for-the-badge&jobUrl=https%3A%2F%2Fci.linuxserver.io%2Fjob%2FDocker-Pipeline-Builders%2Fjob%2Fdocker-bitcoin-knots%2Fjob%2Fmaster%2F&logo=jenkins)](https://ci.linuxserver.io/job/Docker-Pipeline-Builders/job/docker-bitcoin-knots/job/master/)
[![LSIO CI](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=CI&query=CI&url=https%3A%2F%2Fci-tests.linuxserver.io%2Flinuxserver%2Fbitcoin-knots%2Flatest%2Fci-status.yml)](https://ci-tests.linuxserver.io/linuxserver/bitcoin-knots/latest/index.html)
...
[![bitcoin-knots](https://raw.githubusercontent.com/linuxserver/docker-templates/master/linuxserver.io/img/bitcoin-knots-logo.png)](https://bitcoinknots.org/)

## Supported Architectures

We utilise the docker manifest for multi-platform awareness. More information is available from docker [here](https://distribution.github.io/distribution/spec/manifest-v2-2/#manifest-list) and our announcement [here](https://blog.linuxserver.io/2019/02/21/the-lsio-pipeline-project/).

Simply pulling `lscr.io/linuxserver/bitcoin-knots:latest` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
docker run --rm -it \
  --shm-size=1gb \
  -p 3001:3001 \
  lscr.io/linuxserver/bitcoin-knots:latest bash
```
...
| Parameter | Function |
| :----: | --- |
| `3000:3000` | Bitcoin Knots desktop gui HTTP, must be proxied. |
| `3001:3001` | Bitcoin Knots desktop gui HTTPS. |
| `8333:8333` | Bitcoin Knots node port. |
...
| Volume | Function |
| :----: | --- |
| `/config` | Users home directory in the container, stores all data. |
...
[![Docker Mods](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=bitcoin-knots&query=%24.mods%5B%27bitcoin-knots%27%5D.mod_count&url=https%3A%2F%2Fraw.githubusercontent.com%2Flinuxserver%2Fdocker-mods%2Fmaster%2Fmod-list.yml)](https://mods.linuxserver.io/?mod=bitcoin-knots "view available mods for this container.") [![Docker Universal Mods](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=universal&query=%24.mods%5B%27universal%27%5D.mod_count&url=https%3A%2F%2Fraw.githubusercontent.com%2Flinuxserver%2Fdocker-mods%2Fmaster%2Fmod-list.yml)](https://mods.linuxserver.io/?mod=universal "view available universal mods.")
...
* Shell access whilst the container is running:
    ...
    ```bash
    docker exec -it bitcoin-knots /bin/bash
    ```

* To monitor the logs of the container in realtime:

    ```bash
    docker logs -f bitcoin-knots
    ```

* Container version number:

    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' bitcoin-knots
    ```

* Image version number:

    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/bitcoin-knots:latest
    ```
...
* Update containers:
    ...
    * Single container:
        ...
        ```bash
        docker-compose up -d bitcoin-knots
        ```
...
* Update the image:
    ...
    ```bash
    docker pull lscr.io/linuxserver/bitcoin-knots:latest
    ```

* Stop the running container:

    ```bash
    docker stop bitcoin-knots
    ```

* Delete the container:

    ```bash
    docker rm bitcoin-knots
    ```
...
```bash
git clone https://github.com/linuxserver/docker-bitcoin-knots.git
