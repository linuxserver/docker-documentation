...
tags:
    - Games
description: "[Steam](https://store.steampowered.com/) is the ultimate destination for playing, discussing, and creating games."
---
...
docker run --rm -it \
  --shm-size=1gb \
  -p 3001:3001 \
  lscr.io/linuxserver/steam:latest bash
```
...
| Parameter | Function |
| :----: | --- |
| `3000:3000` | Steam desktop gui HTTP must be proxied. |
| `3001:3001` | Steam desktop gui HTTPS. |
