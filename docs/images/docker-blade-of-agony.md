---
title: blade-of-agony
tags:
    - Games
description: "[Wolfenstein: Blade of Agony](https://boa.realm667.com/) is a story-driven WWII shooter inspired by Wolfenstein and Doom."
---
<!-- DO NOT EDIT THIS FILE MANUALLY -->
<!-- Please read https://github.com/linuxserver/docker-blade-of-agony/blob/master/.github/CONTRIBUTING.md -->
# [linuxserver/blade-of-agony](https://github.com/linuxserver/docker-blade-of-agony)

[![Scarf.io pulls](https://scarf.sh/installs-badge/linuxserver-ci/linuxserver%2Fblade-of-agony?color=94398d&label-color=555555&logo-color=ffffff&style=for-the-badge&package-type=docker)](https://scarf.sh)
[![GitHub Stars](https://img.shields.io/github/stars/linuxserver/docker-blade-of-agony.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/linuxserver/docker-blade-of-agony)
[![GitHub Release](https://img.shields.io/github/release/linuxserver/docker-blade-of-agony.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/linuxserver/docker-blade-of-agony/releases)
[![GitHub Package Repository](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=GitHub%20Package&logo=github)](https://github.com/linuxserver/docker-blade-of-agony/packages)
[![GitLab Container Registry](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=GitLab%20Registry&logo=gitlab)](https://gitlab.com/linuxserver.io/docker-blade-of-agony/container_registry)
[![Quay.io](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=Quay.io)](https://quay.io/repository/linuxserver.io/blade-of-agony)
[![Docker Pulls](https://img.shields.io/docker/pulls/linuxserver/blade-of-agony.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=pulls&logo=docker)](https://hub.docker.com/r/linuxserver/blade-of-agony)
[![Docker Stars](https://img.shields.io/docker/stars/linuxserver/blade-of-agony.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=stars&logo=docker)](https://hub.docker.com/r/linuxserver/blade-of-agony)
[![Jenkins Build](https://img.shields.io/jenkins/build?labelColor=555555&logoColor=ffffff&style=for-the-badge&jobUrl=https%3A%2F%2Fci.linuxserver.io%2Fjob%2FDocker-Pipeline-Builders%2Fjob%2Fdocker-blade-of-agony%2Fjob%2Fmaster%2F&logo=jenkins)](https://ci.linuxserver.io/job/Docker-Pipeline-Builders/job/docker-blade-of-agony/job/master/)
[![LSIO CI](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=CI&query=CI&url=https%3A%2F%2Fci-tests.linuxserver.io%2Flinuxserver%2Fblade-of-agony%2Flatest%2Fci-status.yml)](https://ci-tests.linuxserver.io/linuxserver/blade-of-agony/latest/index.html)

[Wolfenstein: Blade of Agony](https://boa.realm667.com/) is a story-driven WWII shooter inspired by Wolfenstein and Doom.

[![blade-of-agony](https://raw.githubusercontent.com/linuxserver/docker-templates/master/linuxserver.io/img/boa-logo.png)](https://boa.realm667.com/)

## Supported Architectures

We utilise the docker manifest for multi-platform awareness. More information is available from docker [here](https://distribution.github.io/distribution/spec/manifest-v2-2/#manifest-list) and our announcement [here](https://blog.linuxserver.io/2019/02/21/the-lsio-pipeline-project/).

Simply pulling `lscr.io/linuxserver/blade-of-agony:latest` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
**To play this you will need to use a GPU!**
...
docker run --rm -it \
  --shm-size=1gb \
  -p 3001:3001 \
  lscr.io/linuxserver/blade-of-agony:latest bash
```
...
docker run -d \
  ...
  --shm-size="1gb" \
  --restart unless-stopped \
  lscr.io/linuxserver/blade-of-agony:latest
```
...
| Parameter | Function |
| :----: | --- |
| `3000:3000` | HTTP Blade of Agony desktop gui must be proxied. |
| `3001:3001` | HTTPS Blade of Agony desktop gui. |
...
| Parameter | Function |
| :-----:   | --- |
| `--shm-size=` | This is needed for Blade of Agony to function. |
...
[![Docker Mods](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=blade-of-agony&query=%24.mods%5B%27blade-of-agony%27%5D.mod_count&url=https%3A%2F%2Fraw.githubusercontent.com%2Flinuxserver%2Fdocker-mods%2Fmaster%2Fmod-list.yml)](https://mods.linuxserver.io/?mod=blade-of-agony "view available mods for this container.") [![Docker Universal Mods](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=universal&query=%24.mods%5B%27universal%27%5D.mod_count&url=https%3A%2F%2Fraw.githubusercontent.com%2Flinuxserver%2Fdocker-mods%2Fmaster%2Fmod-list.yml)](https://mods.linuxserver.io/?mod=universal "view available universal mods.")
...
* Shell access whilst the container is running:
    ...
    ```bash
    docker exec -it blade-of-agony /bin/bash
    ```

* To monitor the logs of the container in realtime:

    ```bash
    docker logs -f blade-of-agony
    ```

* Container version number:

    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' blade-of-agony
    ```

* Image version number:

    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/blade-of-agony:latest
    ```
...
* Update images:
    ...
    * Single image:
        ...
        ```bash
        docker-compose pull blade-of-agony
        ```
...
* Update containers:
    ...
    * Single container:
        ...
        ```bash
        docker-compose up -d blade-of-agony
        ```
...
* Update the image:
    ...
    ```bash
    docker pull lscr.io/linuxserver/blade-of-agony:latest
    ```

* Stop the running container:

    ```bash
    docker stop blade-of-agony
    ```

* Delete the container:

    ```bash
    docker rm blade-of-agony
    ```
...
```bash
git clone https://github.com/linuxserver/docker-blade-of-agony.git
cd docker-blade-of-agony
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/blade-of-agony:latest .
```
